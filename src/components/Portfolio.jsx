        ...
        >
          <div className="container-fluid">
            <div className="row home-content-row">
              ...
              <div className="col-12 col-md-12 col-lg-8 col-xxl-7 salva-home-content dark-salv-portfolio-content  p-0">
                <div
                              ...
                              <div className="salv-menu-design-two">
                                <div className="menu-design-wrap">
                                  ...
                                  <div className="salv-mob-copyright">
                                    <p className="salv-copyright-content mb-0 sm-font inter-font-400 b-text">
                  ...
                  <div>
                    {showPortfolioContent && (
                      <div className="salva-about-content salva-portfolio-content">
                        <div className="salv-inrto-content dark-about-content">
                          ...
                          <div className="salv-home-get-touch dark-home-get-touch salv-portfol-get-btn">
                            <Link
                              to="/contact"
                              target="_blank"
                        ...
                        <div className="salv-tab-filters">
                          <ul className="salv-tab-menu clearfix">
                            <li
                              className={`salv-tab-link dark-salv-tab-link ${
                                activeTab === "one" ? "activ" : ""
                              }`}
                            >
                              <a
                                href="#one"
                                className={`salv-tab-item dark-tab-item all sm-font inter-font-600 ${
                                  activeTab === "one" ? "activ" : ""
                                }`}
                                onClick={(e) => {
                              ...
                              <div className="salv-all-content row">
                                <div className="col-12 col-sm-6 col-md-6 col-lg-4 portfolio-col">
                                  <div className="all-content-wrap detail-page">
                                    ...
                                    <div className="salv-all-conetent">
                                      <h3 className="mb-0 salv-all-title w-text inter-font-700">
                                        Zorro
                                      </h3>
                                ...
                                <div className="col-12 col-sm-6 col-md-6 col-lg-4 portfolio-col">
                                  <div className="all-content-wrap image-page">
                                    ...
                                    <div className="salv-all-conetent">
                                      <h4 className="mb-0 salv-all-title w-text inter-font-700">
                                        Gooir
                                      </h4>
                                      <span className="salv-all-deatils sm-font">
                                        image
                                ...
                                <div className="col-12 col-sm-6 col-md-6 col-lg-4 portfolio-col image-col">
                                  <div className="all-content-wrap slider-page">
                                    ...
                                    <div className="salv-all-conetent">
                                      <h5 className="mb-0 salv-all-title w-text inter-font-700">
                                        Mozar
                                      </h5>
                                      <span className="salv-all-deatils sm-font">
                                        slider
                                ...
                                <div className="col-12 col-sm-6 col-md-6 col-lg-4 portfolio-col tab-top">
                                  <div className="all-content-wrap soundcloud-page">
                                    ...
                                    <div className="salv-all-conetent">
                                      <h6 className="mb-0 salv-all-title w-text inter-font-700">
                                        kana
                                      </h6>
                                      <span className="salv-all-deatils sm-font">
                                        soundcloud
                    ...
                    {showProjectDetail && (
                      <div className="salva-project-content salva-project-detail showpage">
                        <DetailPage />
                        <div className="salv-back-btn dark-salv-back-btn">
