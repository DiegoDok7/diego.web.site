...
import ImgOne from "../assets/images/news/news-one.png";
import ImgTwo from "../assets/images/news/news-two.png";
import ImgThree from "../assets/images/news/news-three.png";
import ImgFour from "../assets/images/news/news-four.png";
import ImgFive from "../assets/images/news/news-five.png";
import ImgSix from "../assets/images/news/news-six.png";
import ImgSeven from "../assets/images/news/news-seven.png";
import ImgEight from "../assets/images/news/news-eight.png";
...
const News = () => {
  ...
  return (
    <>
      <section
        className="salva-fixed-content salva-dark-section"
        id="news_page"
      >
        <div className="container-fluid">
          <div className="row home-content-row">
            ...
            <div className="col-12 col-md-12 col-lg-8 col-xxl-7 salva-home-content dark-news-salv-cont p-0">
              <div
              ...
              >
                      ...
                      <div className="col-6 col-sm-6 col-md-8 col-lg-8">
                        <nav className="navbar salva-header-nav dark-salv-header">
                          <div className="d-flex">
                            ...
                            >
                              <span
                                className={`salv-burger dark-salv-burger ${
                ...
                <div className="salva-news-main-wrap">
                  <div
                    className={`salva-news-content weekend-mode-hide ${
                      showContent ? "hidepage" : ""
                    }`}
                  >
                    <div className="salv-inrto-content portfolio-title dark-about-content">
                      <h2
                    ...
                    <div className="slv-blog-list">
                      {Newblogs.slice(0, visibleBlogs).map((blog, index) => (
                        <div
                          key={blog.id}
                          className={`salv-blog-card dark-salv-blog-card ${
                            blog.id % 2 === 0 ? "reverse" : ""
                          }`}
                        >
                          <div className="salv-blog-wrap dark-salv-blog-wrap">
                            <div className="salv-news-meta">
                              <div
                                className="salv-news-photo"
                                style={{
                                  backgroundImage: `url(${blog.image})`,
                                }}
                              ></div>
                              <div className="salv-news-details"></div>
                            </div>
                            <div
                              className={`salv-news-description ${
                                blog.id % 2 === 0
                                  ? "salv-news-description-reverse"
                                  : ""
                              }`}
                            >
                              <h3 className="salv-news-title mb-0 inter-font-700">
                                {blog.title}
                              </h3>
                              <p className="salv-news-desc mb-0 inter-font-400 sm-md-font-two">
                                {blog.description}
                              </p>
                              <p className="salv-read-more mb-0">
                                <a onClick={() => handleReadMoreClick(index)}>
                                  Read More
                                </a>
                              </p>
                            </div>
                      ...
                      <div className="salv-load-news dark-salv-load-news">
                        {Newblogs.length > visibleBlogs && (
                          <a
                  ...
                  {showContent && (
                    <div
                      className={`salva-single-news-content weekend-mode-hide ${
                        showContent ? "showpage" : ""
                      }`}
                    >
                      <SingleBlogContent />
                      <div className="blog-back-btn dark-blog-back">
