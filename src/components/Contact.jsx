        ...
        >
          <div className="container-fluid">
            <div className="row home-content-row">
              ...
              <div className="col-12 col-md-12 col-lg-8 col-xxl-7 salva-home-content salv-drak-conatct-wrap p-0">
                <div
                ...
                >
                              ...
                              <div className="salv-menu-design-two">
                                <div className="menu-design-wrap">
                                  ...
                                  <div className="salv-mob-copyright">
                                    <p className="salv-copyright-content mb-0 sm-font inter-font-400 w-text light-copyright">
                  ...
                  <div className="salva-contact-us-content weekend-mode-hide">
